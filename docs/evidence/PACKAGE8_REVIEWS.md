...
- The browser bootstrap applies migrations `0005` and `0006`. The local gate records and enforces the exact `531`-test breakdown, including transaction-coupled active-variant selection and its direct simultaneous-request regressions.
